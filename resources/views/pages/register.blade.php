            ...
            <div class="p-3 flex flex-wrap items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <a href="{{ route('login') }}" wire:navigate
                        class="px-2 sm:px-4 py-2 mr-1 text-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 font-semibold rounded-lg text-sm focus:outline-none">Sign
                        in</a>
                </div>
            </div>

            <livewire:actions.register />
