    ...
    <header class="fixed w-full">
        <nav class="bg-white border-gray-200 py-3 dark:bg-gray-900 shadow-md">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <a href="/" class="flex items-center text-red-600 dark:text-white">
                    <x-svg.laravel-logo class="block h-9 fill-current mr-2"></x-svg.laravel-logo>
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <a href="{{ route('login') }}" wire:navigate
                        class="px-4 py-2 mr-1 text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 font-semibold rounded-lg text-sm focus:outline-none">
                        Sign in
                    </a>

                    <x-link.button-purple href="#">Register Now</x-link.button-purple>
